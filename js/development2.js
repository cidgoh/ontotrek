...
Provides all the controls for loading and displaying json graph structures
generated by ontofetch.py from OWL ontologies.  Nothing very special about
the json format.  It can be:
{
 "@context": {
  ...
  "specifications": {
    "[ontology ID]": {
      "id" : "ONTO:123456",
        "parent_id": "oboInOwl:ObsoleteClass",
        "definition": "'GO:nthe specific processes that generate the ability of an organism to cause disease in anothernnnThis is defined in GO so import.'-ID[O]:0000084: GO:nthe specific processes that generate the ability of an organism to cause disease in anothernnnThis is defined in GO so import.",
        "deprecated": "true",
        "id": "IDO:0000084",
        "label": "_obsolete_pathogenesis"
        "synonyms": "disease"
        "ui_label": "user interface label",
        "ui_definition": "user interface definition"
        },
      ...
    },
    "metadata": { // Optional
